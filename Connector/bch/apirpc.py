...
def getAddressHistory(id, params):
    ...
    addrHistory = RPCConnector.request(
        RPC_ELECTRUM_CASH_ENDPOINT, id, GET_ADDRESS_HISTORY_METHOD, [params[ADDRESS]])
...
def getAddressBalance(id, params):
    ...
    connResponse = RPCConnector.request(
        RPC_ELECTRUM_CASH_ENDPOINT, id, GET_ADDRESS_BALANCE_METHOD, [params[ADDRESS]])
...
def getAddressUnspent(id, params):
    ...
    connResponse = RPCConnector.request(
        RPC_ELECTRUM_CASH_ENDPOINT, id, GET_ADDRESS_UNSPENT_METHOD, [params[ADDRESS]])
...
def getTransactionHex(id, params):
    ...
    rawTransaction = RPCConnector.request(
        RPC_ELECTRUM_CASH_ENDPOINT, id, GET_TRANSACTION_METHOD, [params[TX_HASH]])
