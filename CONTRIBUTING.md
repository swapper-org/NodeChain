...
3. Increase the version numbers in `config.json` file and the README.md to the new version that this Pull Request would represent. The versioning scheme we use is specified bellow.
4. You may merge the Pull Request in once you have the sign-off of three other developers, or if you do not have permission to do that, you may request the third reviewer to merge it for you.
